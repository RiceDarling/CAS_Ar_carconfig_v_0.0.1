...
//          osg.mat4.fromTranslation( rowSpecular.getMatrix(), [ 0, 260, 0 ] );
    ...
    window.addEventListener( 'load', function () {
        ...
        $( 'body' ).dataengine().fnquery( function(data)
        {
        	...
        	if(data.type == "color")
        	{
        		example._config.漆面色 = data.color;
        		example._config.金属感 = data.metallic*1.0;
        		example._config.平滑度 = data.roughness*1.0;
        		example.updateRowModelsMetalic();
        		example.updateAlbedo();
